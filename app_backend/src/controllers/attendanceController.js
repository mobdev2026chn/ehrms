...
const getTodayAttendance = async (req, res) => {
    try {
        ...
        const { isCurrentlyInLeaveSession, isWithinSecondHalfEarlyLoginWindow, getLeaveMessageForUI, canCheckInWithHalfDayLeave, canCheckOutWithHalfDayLeave, getHalfDaySessionMessage, getShiftTimings, getBusinessTimezone, isHalfDayLeave } = require('../utils/leaveAttendanceHelper');
        ...
        if (activeLeave) {
            const leaveStatus = isHalfDayLeave(activeLeave) ? 'Half Day' : 'On Leave';
            ...
            if (attendance) {
                ...
                if (isHalfDayLeave(activeLeave) && (halfDaySessionVal || sessionVal)) {
                ...
                attendance = {
                    ...
                    date: startOfDay,
                    employeeId: req.staff._id,
                    ...(isHalfDayLeave(activeLeave) && { halfDaySession: halfDaySessionVal, session: sessionVal })
                };
            }
        }
        ...
        const hasApprovedHalfDayLeave = activeLeave && isHalfDayLeave(activeLeave);
        ...
        const halfDayLeaveForHelper = (halfDaySource && activeLeave && isHalfDayLeave(activeLeave))
            ? {
                ...activeLeave,
                leaveType: 'Half Day',
                ...halfDaySource,
