...
async function getActiveBreakForDevice(device) {
    if (!device?.employeeID || !device?.tenantId) return null;
    return await Break.findOne({
...
/** POST /break/start - Insert break document when user starts tea break. */
