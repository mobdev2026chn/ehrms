...
class LivePrimaryFace {
  ...
  /// Head yaw (headEulerAngleY, degrees) of the largest face. Null when no face.
  final double? headYaw;

  /// Whether the eyes are open on the largest face. Null when classification is off.
  final bool? eyesOpen;

  /// Whether the largest face appears occluded. Null when landmarks are off.
  final bool? occluded;
