  ...
  */
  ...
  Future<void> _openMarkAttendanceScreen() async {
    ...
    */
    ...
    // template's "Require Selfie" toggle is on, gated by the punch master switch.
    // With AppConstants.enablePunchSelfie off (or the template flag off), punch
    // never opens the camera (submits without a selfie).
